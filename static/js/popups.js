...
License: public domain ("And some people have asked me about a license for this piece of code. I think itâ€™s far too short to get its own license, so Iâ€™m relinquishing any copyright claims. Consider the code to be public domain. No attribution is necessary.")
	*/
Popups = {
	/**********/
	/*	Config.
	...
	positionPopup: (popup, spawnPoint) => {
		...
		//  Wait for the â€œnaiveâ€ layout to be completed, and then...
		requestAnimationFrame(() => {
    ...
    //	The â€œuser moved mouse out of popupâ€ mouseleave event.
	...
	//	The â€œuser moved mouse back into popupâ€ mouseenter event.
	...
	targetMouseenter: (event) => {
		...
		if (event.target.popup == null) {
			...
			//  Restore popupâ€™s scroll position.
